...
function loadsolidity(chal) {
    var chalid = $('.chal-id').val();
    $.get(script_root + '/admin/chal/' + chalid + '/solidity', {
    }, function(data){
        $('#solidity-editor').val(data['solidity']);
    });
}

function loadtestfunc(chal) {
    var chalid = $('.chal-id').val();
    $.get(script_root + '/admin/chal/' + chalid + '/test_func', {
    }, function(data){
        $('#test-func-editor').val(data['test_func']);
    });
}
